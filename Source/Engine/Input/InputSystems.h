...
namespace viper {
	...
	public:
		...
		bool GetKeyPressed(uint8_t key) const { return m_keyboardState[key] && !m_prevKeyboardState[key]; }
		bool GetKeyReleased(uint8_t key) const { return !m_keyboardState[key] && m_prevKeyboardState[key]; }
